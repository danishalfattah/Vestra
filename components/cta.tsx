        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary/10 via-primary/5 to-accent/10 p-8 lg:p-16">
          <div className="relative z-10 text-center">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-balance">
              Siap Mengubah <span className="text-primary">Masa Depan Keuangan</span> Anda?
            </h2>

            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
              Bergabunglah dengan ribuan pelajar yang sudah membangun kekayaan dan mengamankan kemandirian finansial
              mereka melalui edukasi cerdas.
            </p>
